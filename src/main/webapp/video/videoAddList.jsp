		...
		<c:forEach var="dto" items="${cartList}">
			...
			<tr>
				...
				<td class="td_default" width="80"><img
					...
					width="80" /></td>
				<td class="td_default" width="300" style='padding-left: 30px'>제나
					레이스 스커트 <br> <font size="2" color="#665b5f">[옵션 :
						사이즈(L)(${dto.gSize}) , 색상(${dto.gColor})] </font>
				</td>
				<td class="td_default" align="center" width="110">
					${dto.gPrice}</td>
				<td class="td_default" align="center" width="90"><input
					class="input_default" type="text" name="CART_AMOUNT"
					id="CART_AMOUNT81" style="text-align: right" maxlength="3" size="2"
					value="3"></input></td>
				<td><input type="button" value="수정"
					onclick="amountUpdate('81')" /></td>
				<td class="td_default" align="center" width="80"
					style='padding-left: 5px'><span id="sum81"> ￦29,400 </span></td>
