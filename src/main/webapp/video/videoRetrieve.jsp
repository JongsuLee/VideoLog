		...
		<tr>
			<td>
				<table align="center" width="710" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td class="td_default"><font size="5"><b>- Video 정보 -</b></font>
							&nbsp;</td>
					</tr>
					<tr>
						<td height="5"></td>
					...
					<tr>
						<td rowspan="7"><img src="images/items/${videoRetrieve.gImage}.gif"
					...
					<tr>
						...
						<fmt:formatNumber value="${videoRetrieve.readcnt}" type="currency" />
						</td>
					</tr>
				</table>
